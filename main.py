from src.analytics import filter_state
...
3. Получить информацию о транзакциях из XLSX-файла"""
    ...
    if choise_file == 1:
        ...
        transaction = read_json("data/operations.json")
    elif choise_file == 2:
        print("Программа: Для обработки выбран CSV-файл. ")
        transaction = reading_csv("data/transactions.csv")
    elif choise_file == 3:
        print("Программа: Для обработки выбран XLSX-файл. ")
        transaction = reading_xlsx("data/transactions_excel.xlsx")
